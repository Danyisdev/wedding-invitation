...
<body>
		...
		<div id="floating-button" class="float">
			<div class="control-center open">
				<div class="audio-play">
					<div data-video="o7CbZQwnxZc" data-autoplay="0" data-loop="1" id="youtube-audio1"></div>
				</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
						...
						<br>
						<p>
							<a href="https://calendar.google.com/calendar/event?action=TEMPLATE&tmeid=M3I2MjlpYjQ2aXBwM21wM3VvdWZzMjRoaHEgZGFueXhkZXZlbG9wQG0&tmsrc=danyxdevelop%40gmail.com" target="_blank" class="btn btn-primary btn-sm">Save the date</a><br>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						...
						<div class="col-md-6 col-sm-6 text-center">
							<div class="event-wrap animate-box">
								<h3 style="font-family: 'Oswald', Arial, serif;">Resepsi Pernikahan</h3>
								<div class="event-col">
									<i class="icon-clock"></i>
									<span>Waktu</span>
									<span class="tanggal">11:00 s.d. 13:00</span>
								</div>
								<div class="event-col">
									<i class="icon-calendar"></i>
									<span>Sabtu</span>
									<span class="tanggal">22 Februari 2025</span>
								</div>
								<p style="font-family: 'Courgette', Arial, serif">Alamat : Masjid Siti Rawani, Jati Asih, Bekasi, Jawa Barat</p>

								<a href="https://maps.app.goo.gl/cH1Wp6UCg4zLL2VcA" target="_blank" class="btn btn-primary">Penunjuk Lokasi <i class="icon-map2"></i></a>
							</div>
						</div>
		...
		<div id="fh5co-health-protocol">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
						...
						<p>Jika berkenan memberikan hadiah, Anda dapat mengirimkan ke rekening berikut:</p>
					</div>
					<div class="row">
						<div class="col-md-6 col-sm-6 text-center">
							<div class="event-wrap animate-box">
				...
				<div class="container">
					...
					<div class="row animate-box">
						<div class="col-md-8 col-md-offset-2">
							<div id="ucapanContainer" style="overflow-y: auto; max-height: 300px; border: 1px solid #ddd; padding: 10px; border-radius: 5px;">
								<ul id="ucapanList" class="list-group mb-0"></ul>
							</div>
						</div>
					</div>

					<!-- <form id="formUcapan" class="mb-30">
						<div>
			...
			<div id="fh5co-started" class="fh5co-bg" style="background-image:url(images/img_bg_4.jpg);">
				...
				<div class="container">
					...
					<div id="responseMessage" class="mb-30 text-center"></div>
					<div class="row animate-box">
						<div class="col-md-10 col-md-offset-1">
							<form class="form-inline" id="formUcapan">
								...
								<div class="col-md-4 col-sm-4">
									<div class="form-group">
										...
										<textarea id="ucapan" name="ucapan" class="form-control" rows="4" placeholder="Ucapan Kamu" required></textarea>
									</div>
								</div>
								<div class="col-md-4 col-sm-4">
									<button type="submit" class="btn btn-default btn-block">Kirim Ucapan</button>
								</div>
							</form>
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="row copyright animate-box">
						<div class="col-md-12 text-center">
							...
							<br>
							<h1 style="font-family: 'Satisfy', Arial, serif">Yunio & Ayu</h1>
							<p>
								© Copyright 2025 Danyxdev All Rights Reserved </br>
								<!-- <small>Instagram : dnyx,v | Whatsapp : (+62) 853-6006-1021 | NikahDigital.com |halo@nikahdigital.com</small> -->
								<!-- <ul class="fh5co-social-icons">
	...
	<a href="#" class="js-gotop"><i class="icon-arrow-up"></i></a>
		...
		<script type="text/javascript">
			...
			var targetYear = 2025;
			var targetMonth = 1; // Feb (since months in JavaScript Date are 0-based)
			var targetDay = 22;
			var targetHour = 11;
			var targetMinute = 0;

			// Create a Date object for the countdown
			var d = new Date(targetYear, targetMonth, targetDay, targetHour, targetMinute, 0, 0);

			// Initialize simplyCountdown with correct values
			simplyCountdown('.simply-countdown-wedding', {
				year: d.getFullYear(), // Extracts year (2022)
				month: d.getMonth() + 1, // Extracts month (convert 0-based to 1-based)
				day: d.getDate(), // Extracts day (20)
				hour: d.getHours(), // Extracts hour (18)
				minutes: d.getMinutes(), // Extracts minute (0)
				seconds: 0, // Default to 0 seconds
				countUp: true // Start counting up after reaching zero
				// enableUtc: true             // Uncomment if you want UTC time instead of local time
			});
